...
var labeljk = [@foreach($jenis_kelamin as $jk) '{{ $jk->jk }}', @endforeach];
var datajk = [@foreach($jenis_kelamin as $jk) {{ $jk->jumlah }}, @endforeach];
...
var labelhh = [@foreach($hitung_harga as $hitung) '{{ $hitung->nama }}', @endforeach];
var datahh = [@foreach($hitung_harga as $hitung) {{ $hitung->harga_jual }}, @endforeach];
document.addEventListener("DOMContentLoaded", () => {
