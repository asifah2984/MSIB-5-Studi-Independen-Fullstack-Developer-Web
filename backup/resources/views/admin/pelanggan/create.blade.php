...
<form method="POST" action="{{route('pelanggan.store')}}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text3" name="nama" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
        ...
        <div class="form-check">
            <input name="jk" id="radio_0" type="radio" class="form-check-input" value="{{ $g }}"> 
  ...
  <div class="form-group row">
    <label for="text6" class="col-4 col-form-label">Tanggal Lahir</label> 
    <div class="col-8">
      <input id="text6" name="tgl_lahir" type="date" class="form-control">
    </div>
  </div>
  <div class="form-group row">
