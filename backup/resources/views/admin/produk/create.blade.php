...
<form method="POST" action="{{url('admin/produk/store')}}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text3" name="nama" type="text" class="form-control @error('nama') is-invalid @enderror">
      @error('nama')
      <div class="invalid-feedback">
        {{$message}}
      </div>
  ...
  <div class="form-group row">
    <label for="text6" class="col-4 col-form-label">Harga Jual</label> 
    <div class="col-8">
      <input id="text6" name="harga_jual" type="text" class="form-control @error('harga_jual') is-invalid @enderror">
      @error('harga_jual')
      <div class="invalid-feedback">
        {{$message}}
      </div>
